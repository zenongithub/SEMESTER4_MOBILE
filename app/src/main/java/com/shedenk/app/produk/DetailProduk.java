...
public class DetailProduk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(DetailProduk.this).load(image).apply(new RequestOptions().centerCrop()).into(gambar);
...
//                                    Toast.makeText(getApplicationContext(), "Berhasil Menambahkan Simpan", Toast.LENGTH_SHORT).show();
                                    new SweetAlertDialog(DetailProduk.this, SweetAlertDialog.SUCCESS_TYPE)
                                            .setTitleText("Berhasil Menambahkan Simpan")
                                    ...
                                    new SweetAlertDialog(DetailProduk.this, SweetAlertDialog.WARNING_TYPE)
