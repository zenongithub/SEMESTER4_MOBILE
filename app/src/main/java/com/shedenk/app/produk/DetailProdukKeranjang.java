...
//        ukurankeranjang.setText("Ukuran : "+getIntent().getExtras().getString("ukuran"));
        ...
        Glide.with(DetailProdukKeranjang.this).load(image).apply(new RequestOptions().centerCrop()).into(gambarkeranjang);
    ...
    private void HapusKeranjang(String hid_akun, String hid_produk) {
        if (checkNetworkConnection()) {
            String url = Env.BASE_URL + "hapuskeranjang";
...
//                                    Toast.makeText(getApplicationContext(), "Berhasil Menghapus", Toast.LENGTH_SHORT).show();
                                    new SweetAlertDialog(DetailProdukKeranjang.this, SweetAlertDialog.SUCCESS_TYPE)
                                            .setTitleText("Berhasil Menghapus Keranjang!")
...
//                                    Toast.makeText(getApplicationContext(), "Gagal Menghapus", Toast.LENGTH_SHORT).show();
                                    new SweetAlertDialog(DetailProdukKeranjang.this, SweetAlertDialog.WARNING_TYPE)
                                            .setTitleText("Gagal Menghapus Keranjang!")
                                            .show();
                                }
