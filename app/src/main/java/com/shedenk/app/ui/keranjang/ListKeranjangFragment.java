...
public class ListKeranjangFragment extends Fragment implements RecyclerViewListener {
    ...
    private void loadData(Context context, String id){
        ...
        String url = Env.BASE_URL + "datakeranjang";
...
//                    Toast.makeText(context, "Berhasil Mengambil Data", Toast.LENGTH_SHORT).show();
                    ...
                    adapterProdukKeranjang = new AdapterProdukKeranjang(data, ListKeranjangFragment.this);
...
//                    System.out.println(data.size());
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_list_keranjang, container, false);
...
//        scaleBitmap = Bitmap.createScaledBitmap(bitmap, 1200, 518, false);
        ...
        btn_pesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(data.size() == 0){
                    ...
                    new SweetAlertDialog(getActivity(), SweetAlertDialog.WARNING_TYPE)
                            .setTitleText("Apakah Ingin Membuat Pesanan?")
                            .setConfirmText("Ya, Buat!")
                            .setCancelText("Batal")
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                @Override
                                public void onClick(SweetAlertDialog sDialog) {
                                    String stotal = String.valueOf(total);
                                    String stotalbarang = String.valueOf(data.size());
                                    String sid_akun = id_akun.getText().toString();

                                    TambahAntrian(stotal,stotalbarang, sid_akun);
    ...
    private void TambahAntrian(String stotal, String stotalbarang, String sid_akun) {
...
//                                System.out.println(data.size());
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("total_barang", stotalbarang);
